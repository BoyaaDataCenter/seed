...
class ForgetPassword(RestfulBaseView):
    ...
    def post(self):
        ...
        reset_redirect_url = '{active_host}/users/active_account&active_token={active_token}'
        reset_redirect_url = reset_redirect_url.format(active_host=request.host, reset_token=reset_token)
